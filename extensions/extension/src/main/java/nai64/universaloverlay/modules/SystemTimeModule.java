...
public final class SystemTimeModule extends UniversalOverlayStatisticModule {
    public SystemTimeModule() { super("systemTime", "System time", "Phone date and time in 24-hour and 12-hour formats. Monitor short name: ST."); }
    ...
    @Override protected String monitorValue() {
        return "ST: " + new SimpleDateFormat("HH : mm", Locale.getDefault()).format(new Date());
    }
}
